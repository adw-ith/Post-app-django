...
def registerUser(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(
                request, 'An error occured during sign up!Try again!')
...
def UpdateRoom(request, pk):
    ...
    if request.user != room.host:
        return HttpResponse('You do not have the required permisssion')
...
def updateUser(request):
    ...
    context = {'form': form}
    return render(request, 'basic/update-user.html', context)
...
def topicsPage(request):
    ...
    return render(request, 'basic/topics.html', context)
...
def activityPage(request):
    ...
    return render(request, 'basic/activity.html', context)
